...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "main", "net", "prog", "music", "img", "misc" }, s, layouts[2])
end
-- }}}
...
vicious.register(mutewidget, vicious.widgets.volume, "$2 ", 1, "Master")

volwidget = awful.widget.progressbar()
volwidget:set_width(20)
...
awful.widget.layout.margins[volwidget.widget] = { top = 4 }
vicious.register(volwidget, vicious.widgets.volume, "$1", 1, "Master")

batwidget = awful.widget.progressbar()
batwidget:set_width(20)
batwidget:set_height(10)
batwidget:set_background_color("#494B4F")
batwidget:set_border_color(nil)
batwidget:set_color("#AECF96")
batwidget:set_gradient_colors({ "#AECF96", "#88A175", "#FF5656" })
awful.widget.layout.margins[batwidget.widget] = { top = 4, left = 2, right = 6 }
vicious.register(batwidget, vicious.widgets.bat, "$2", 1, "BAT0")

baticon = widget({ type = "imagebox" })
baticon.image = image(awful.util.getdir("config") .. "/battery.png")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.util.spawn("uzbl-browser") end),
    ...
    awful.key({ modkey, "Shift", "Control" }, "h",     function () awful.tag.incncol( 1)         end),
    awful.key({ modkey, "Shift", "Control" }, "l",     function () awful.tag.incncol(-1)         end),
